...
#importing function to clear cell output
    ...
    if player_1==True:
        for row in tic_tac_toe_board:
            if row[0]==row[1] and row[1]==row[2] and row[0]!='':
                ...
                return has_won
        for itr in range(3):
            if tic_tac_toe_board[0][itr]!= '' and tic_tac_toe_board[0][itr] == tic_tac_toe_board[1][itr] and tic_tac_toe_board[1][itr] == tic_tac_toe_board[2][itr]:
                print("Player_1 has won")
                has_won=True
                return has_won
        if tic_tac_toe_board[0][0] == tic_tac_toe_board[1][1] and tic_tac_toe_board[1][1]== tic_tac_toe_board[2][2] and tic_tac_toe_board[2][2]!='':
            print("Player_1 has won")
            has_won=True
            return has_won
        if tic_tac_toe_board[2][0] == tic_tac_toe_board[1][1] and tic_tac_toe_board[1][1]==tic_tac_toe_board[0][2] and tic_tac_toe_board[1][1]!='':
            print("Player_1 has won")
            has_won=True
            return has_won
    else:
        for row in tic_tac_toe_board:
            if row[0]==row[1] and row[1]==row[2] and row[0]!='':
                ...
                return has_won
        for itr in range(3):
            if tic_tac_toe_board[0][itr] == tic_tac_toe_board[1][itr] and tic_tac_toe_board[1][itr] == tic_tac_toe_board[2][itr] and tic_tac_toe_board[2][itr]!='':
                print("Player_2 has won")
                has_won=True
                return has_won
        if tic_tac_toe_board[0][0] == tic_tac_toe_board[1][1] and tic_tac_toe_board[1][1] == tic_tac_toe_board[2][2] and tic_tac_toe_board[2][2]!='':
